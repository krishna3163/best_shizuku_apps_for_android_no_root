...
| **[ownapps](https://github.com/jehan593/ownapps)** | Fully offline Android app manager: manually disable/enable apps via a Shizuku-family backend, with a scriptable UI Hider overlay. | See project | [GitHub](https://github.com/jehan593/ownapps) |
