...
| **[adb-tv-mcp](https://github.com/mosesmrima/adb-tv-mcp)** | Give AI agents eyes & hands on your Android TV — an MCP server over ADB (screenshots, D-pad, apps, wireless pairing). | See project | [GitHub](https://github.com/mosesmrima/adb-tv-mcp) |
| **[adb_tool](https://github.com/Shrinetaadi/adb_tool)** | Wireless ADB tool for Android TV — Windows + Android apps. Made with love by Aditya. | See project | [GitHub](https://github.com/Shrinetaadi/adb_tool) |
...
| **[AdbKit](https://github.com/56duong/AdbKit)** | AdbKit - Wireless ADB remote control, shell console, app manager, and system tools for Android devices. | See project | [GitHub](https://github.com/56duong/AdbKit) |
| **[adbwifi-toggle](https://github.com/afluffywaffle/adbwifi-toggle)** | No-root Android app to toggle Wireless Debugging (adb over Wi-Fi) from the launcher — for Supernote e-readers & locked-down devices where Developer Options are hard to reach. | See project | [GitHub](https://github.com/afluffywaffle/adbwifi-toggle) |
| **[agentic-nexus](https://github.com/niki914/agentic-nexus)** | Android Native AI agent for phone automation — control apps via Accessibility / Root / Shizuku, run Shell / SSH commands, and extend with MCP, Skills | See project | [GitHub](https://github.com/niki914/agentic-nexus) |
| **[Android-Dex](https://github.com/Shrey113/Android-Dex)** | Enable a full desktop experience from any Android device over Wi‑Fi. No root, scrcpy-powered, Flutter desktop app with wireless ADB, per‑app audio, and quick controls. | See project | [GitHub](https://github.com/Shrey113/Android-Dex) |
...
| **[android-dpi-tool](https://github.com/yisallu/android-dpi-tool)** | Android one-tap DPI switch tool (Shizuku / WRITE_SECURE_SETTINGS) | See project | [GitHub](https://github.com/yisallu/android-dpi-tool) |
...
| **[Android-Non-Root](https://github.com/Willie169/Android-Non-Root)** | Open-source tools for non-root Android functionality, security, privacy, and customization, such as Termux, F-Droid, Shizuku, Tor, TrackerControl, InviZible Pro, QEMU, Tailscale, OpenSSH, and PipePipe. | See project | [GitHub](https://github.com/Willie169/Android-Non-Root) |
...
| **[android-toolkit](https://github.com/00AstroGit00/android-toolkit)** | A modular, non-root Android optimization and diagnostics toolkit. Targets Android 13–16 and Samsung One UI 5–8. Works with ADB (USB/wireless) or Shizuku/rish. No root required. | See project | [GitHub](https://github.com/00AstroGit00/android-toolkit) |
...
| **[AODControl](https://github.com/huraizkhan/AODControl)** | A lightweight Android app for controlling AOD opacity, smart dimming, and screen-off fingerprint behavior using Shizuku. | See project | [GitHub](https://github.com/huraizkhan/AODControl) |
| **[ApKilla](https://github.com/Bl0ck154/ApKilla)** | One-tap Android Quick Settings tile that force-stops the last used app without root, ADB, Shizuku, or Tasker. | See project | [GitHub](https://github.com/Bl0ck154/ApKilla) |
...
| **[Aura](https://github.com/tgvdufuture/Aura)** | Custom notification LED app for the POCO X8 Pro (HyperOS / Xiaomi) — per-app, per-contact and per-group RGB colors and animations on the back LED rings, no root required (Shizuku). | See project | [GitHub](https://github.com/tgvdufuture/Aura) |
...
| **[deepseek-harness-android-app](https://github.com/woaiys3/deepseek-harness-android-app)** | DeepSeek Harness 手机版：可直接安装的 Android APK，AI 免 Root 操作手机（Shizuku/root 可选），文件编辑只需所有文件访问权限，前台保活 + AI 通知 | See project | [GitHub](https://github.com/woaiys3/deepseek-harness-android-app) |
| **[Dioxamine](https://github.com/rhythmcache/Dioxamine)** | Android app to send ADB commands, mirror screens, use Fastboot, and control other Android devices over USB OTG or Wireless ADB | See project | [GitHub](https://github.com/rhythmcache/Dioxamine) |
...
| **[KillMyApps](https://github.com/dedeadend/KillMyApps)** | Efficient app killer for Android. Terminate background processes to boost performance and save battery. | See project | [GitHub](https://github.com/dedeadend/KillMyApps) |
...
| **[mcpshell](https://github.com/xnet-admin-1/mcpshell)** | Android MCP server with sh, proot Ubuntu, and Shizuku rish shell tools | See project | [GitHub](https://github.com/xnet-admin-1/mcpshell) |
...
| **[MistConnect](https://github.com/rejian2022/MistConnect)** | Android MCP bridge: phone state, UI control, Shizuku shell tools for AI agents \| Android MCP 桥接：手机状态、UI 控制、Shizuku shell 工具，给 AI 客户端用 | See project | [GitHub](https://github.com/rejian2022/MistConnect) |
...
| **[Simple-wireless-ADB](https://github.com/PhenixStar/Simple-wireless-ADB)** | Simple Wireless ADB - ROOT REQUIRED - Lightweight Android app to enable wireless ADB on rooted devices | See project | [GitHub](https://github.com/PhenixStar/Simple-wireless-ADB) |
| **[spider-gfx-tool](https://github.com/GfxGamerLab/spider-gfx-tool)** | Official repository for Spider GFX Tool - A local Android gaming performance utility app providing lag fixes and system optimization via Shizuku integration. | See project | [GitHub](https://github.com/GfxGamerLab/spider-gfx-tool) |
| **[SwiftSense](https://github.com/itsmelissadev/SwiftSense)** | SwiftSense is a versatile Android toolkit to boost gaming performance. It forces sensor rates to 200Hz+ and manages background apps via Shizuku to reduce CPU load. A privacy-focused, open-source project. | See project | [GitHub](https://github.com/itsmelissadev/SwiftSense) |
...
| **[termux-shizuku-tools](https://github.com/jecis-repos/termux-shizuku-tools)** | Termux tools with Shizuku/rish integration for Android 16+ | See project | [GitHub](https://github.com/jecis-repos/termux-shizuku-tools) |
| **[tether-adb](https://github.com/shadowline-trx/tether-adb)** | Tether ADB — enterprise-grade wireless & wired Android device control. QR pairing, screen mirror, logcat, shell, files, apps, automation. Windows. | See project | [GitHub](https://github.com/shadowline-trx/tether-adb) |
...
| **MicroG-RE** | MorpheApp | `6.1.4` | 2026-08-22 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/microg-re-6.1.4) | [GitHub](https://github.com/MorpheApp/MicroG-RE) |
...
| **Morphe AutoBuilds** | RookieEnough | `latest` | 2026-08-23 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-autobuilds-latest) | [GitHub](https://github.com/RookieEnough/Morphe-AutoBuilds) |
| **Morphe Manager** | MorpheApp | `v1.27.0` | 2026-08-22 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-manager-v1.27.0) | [GitHub](https://github.com/MorpheApp/morphe-manager) |
