...
| **[AppPerms](https://github.com/xykal/AppPerms)** | AppOps / Display-over-other-apps manager untuk Android via Shizuku — 1.9MB, 0 internet permission, 19 hidden ops, terminal, safe tuning | See project | [GitHub](https://github.com/xykal/AppPerms) |
...
| **[awesome-shizuku](https://github.com/timschneeb/awesome-shizuku)** | Curated list of awesome Android apps making use of Shizuku | See project | [GitHub](https://github.com/timschneeb/awesome-shizuku) |
...
| **[FreeFile](https://github.com/MetxStudio/FreeFile)** | FreeFile is a Kotlin and Jetpack Compose-based Android file manager with dual-pane navigation, Root/Shizuku support, remote storage, terminal integration, scripting, APK tools and so on. | See project | [GitHub](https://github.com/MetxStudio/FreeFile) |
...
| **[WebAppForAndroid](https://github.com/zhoujun94511/WebAppForAndroid)** | 📱面向测试与研发的 Android 设备 Web 调试控制台--A cross-platform browser-based Android debugger for USB/wireless adb, app management, screenshots, scrcpy mirroring, and AAB-to-APK signing on Windows, Linux, and macOS. | See project | [GitHub](https://github.com/zhoujun94511/WebAppForAndroid) |
...
| **[WifiPad](https://github.com/TomasThrawat/WifiPad)** | Phone-as-gamepad over LAN: controller-app (touch dual-stick + buttons, UDP sender) and receiver-app (Shizuku + AOSP uinput, registers as an Xbox 360 wired gamepad) for Android TV. | See project | [GitHub](https://github.com/TomasThrawat/WifiPad) |
...
| **[Xiaomi-Toolkit](https://github.com/minhtiencr123/Xiaomi-Toolkit)** | Xiaomi Toolkit GitHub chính thức của minhtiencr123 – ứng dụng Android sửa lỗi thông báo Xiaomi MIUI/HyperOS cho máy nội địa Trung Quốc, dùng Shizuku, không cần root. | See project | [GitHub](https://github.com/minhtiencr123/Xiaomi-Toolkit) |
...
| **Morphe AutoBuilds** | RookieEnough | `latest` | 2026-09-25 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-autobuilds-latest) | [GitHub](https://github.com/RookieEnough/Morphe-AutoBuilds) |
