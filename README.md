...
| **[freezing_application](https://github.com/NhatKyAnhPhan/freezing_application)** | Tích hợp shizuku đóng băng all app trên android 1 chạm nhưng ko killapp giúp các app thông báo vẫn gửi thông báo | See project | [GitHub](https://github.com/NhatKyAnhPhan/freezing_application) |
| **[GitSentry](https://github.com/pufferfish-salad/GitSentry)** | GitSentry — Silent, permission-aware updates for GitHub-distributed Android apps. Tracks repos you choose via the GitHub Releases API, installs updates silently using Shizuku's elevated access (no root), and warns you before installing if an update adds new dangerous permissions compared to the currently installed version. | See project | [GitHub](https://github.com/pufferfish-salad/GitSentry) |
