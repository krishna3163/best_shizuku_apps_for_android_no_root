...
| **[app-disabler](https://github.com/lxrdspro/app-disabler)** | Lightweight Android GUI application using Shizuku to manage installed applications for Android users/profiles | See project | [GitHub](https://github.com/lxrdspro/app-disabler) |
...
| **[RecentsHider](https://github.com/czeyu31/RecentsHider)** | Hide apps from recent tasks using Shizuku - Android | See project | [GitHub](https://github.com/czeyu31/RecentsHider) |
...
| **[Shizako](https://github.com/cr1437/Shizako)** | 猫耳看板娘版的 Shizuku \| A catgirl-mascot edition of Shizuku — use privileged Android APIs without root. Official Shizuku-API apps connect without code changes. Apache-2.0 | See project | [GitHub](https://github.com/cr1437/Shizako) |
...
| **[sidebar-hyperos](https://github.com/echu2237/sidebar-hyperos)** | Root-free MIUI-style sidebar for HyperOS - apps open in real freeform windows via Shizuku | See project | [GitHub](https://github.com/echu2237/sidebar-hyperos) |
...
| **[Uraam](https://github.com/Uraam/Uraam)** | Universal Ruvomain ADB App Manager [URAAM]: An all-in-one shell toolkit for Android debloating. Uninstall/disable your apps, backup your debloat apps JSON file & revert/restore, install apk. Works with "Termux  `WirelessADB, Shizuku, Root', Linux `Debian, Arch, Fedora, macOS & WSL '. Compatible with Canta/UAD JSON lists. | See project | [GitHub](https://github.com/Uraam/Uraam) |
...
| **[ZF-Android-Agent](https://github.com/mzf1378197541/ZF-Android-Agent)** | A phone-native Android AI agent with native tools, Root/Shizuku, accessibility automation and an optional Linux workspace. | See project | [GitHub](https://github.com/mzf1378197541/ZF-Android-Agent) |
...
| **Morphe AutoBuilds** | RookieEnough | `latest` | 2026-09-15 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-autobuilds-latest) | [GitHub](https://github.com/RookieEnough/Morphe-AutoBuilds) |
| **Morphe Manager** | MorpheApp | `v1.31.0` | 2026-09-15 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-manager-v1.31.0) | [GitHub](https://github.com/MorpheApp/morphe-manager) |
...
| **PrivacyFlip** | dorumrr | `v2.1.7` | 2026-09-11 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/privacyflip-v2.1.7) | [GitHub](https://github.com/dorumrr/privacyflip) |
