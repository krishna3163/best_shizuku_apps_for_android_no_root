...
| **[gkd-](https://github.com/84593320z/gkd-)** | GKD-X 融合版：界面全面适配 MIUIX 的 GKD-X与GKD-Plus的AI规则生成 App 开屏与弹窗广告（Android / Kotlin Compose） | See project | [GitHub](https://github.com/84593320z/gkd-) |
...
| **[netswitcher](https://github.com/nd4y/netswitcher)** | Fast Wi-Fi / LTE / Ethernet switching on Android: buttons in the app, a shortcut, a widget and a quick settings tile. Privileges via Shizuku. | See project | [GitHub](https://github.com/nd4y/netswitcher) |
| **[PerAppDpi](https://github.com/suifonouyang-sudo/PerAppDpi)** | 按应用单独调整 DPI 的 Android 工具，含悬浮窗实时调节（Shizuku/Sui + wm density 全局切换） | See project | [GitHub](https://github.com/suifonouyang-sudo/PerAppDpi) |
...
| **[Service-Keeper](https://github.com/sklndev/Service-Keeper)** | Android app that monitors and automatically restarts background services, accessibility services, and notification listeners killed by the system, using Shizuku for privileged access. | See project | [GitHub](https://github.com/sklndev/Service-Keeper) |
