...
| **[AppUsageWatch-v1.4.1-v1.0.0](https://github.com/cnwhcmc/AppUsageWatch-v1.4.1-v1.0.0)** | Android app usage & file event monitor. Records app foreground/background time and file operations (write/move/create/delete) with optional Root/Shizuku enhanced accuracy. Pure Kotlin, ~830KB APK, minSdk 25. | See project | [GitHub](https://github.com/cnwhcmc/AppUsageWatch-v1.4.1-v1.0.0) |
...
| **[ownapps](https://github.com/jehan593/ownapps)** | Fully offline Android app manager. Disable, enable, pin, and firewall your apps with Shizuku. No internet, no tracking, no analytics. | See project | [GitHub](https://github.com/jehan593/ownapps) |
...
| **[Uraam](https://github.com/Ruvyrom/Uraam)** | Universal Ruvomain ADB App Manager: An all-in-one shell script for Android debloating, app backup/restore, and APK installation. Works with Linux, macOS, WSL & Termux (WirelessADB, Shizuku, Root). Compatible with Canta/UAD JSON lists. | See project | [GitHub](https://github.com/Ruvyrom/Uraam) |
...
| **Dragon-Launcher** | Elnix90 | `4.1.4` | 2026-09-08 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/dragon-launcher-4.1.4) | [GitHub](https://github.com/Elnix90/Dragon-Launcher) |
...
| **Morphe AutoBuilds** | RookieEnough | `latest` | 2026-09-12 | [⬇️ Download](https://github.com/krishna3163/best_shizuku_apps_for_android_no_root/releases/tag/morphe-autobuilds-latest) | [GitHub](https://github.com/RookieEnough/Morphe-AutoBuilds) |
